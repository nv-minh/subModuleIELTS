...
const FEATURES: Feature[] = [
  ...
  },
  {
    icon: '📝',
    title: 'Prompt',
    desc: 'Receive tailored prompts to kickstart your writing or speaking practice, helping you generate ideas and structure your responses effectively.',
  },
  {
    icon: '🗣️',
    title: 'Speaking with AI',
    desc: 'Engage in interactive speaking exercises with the AI to practice your conversational skills and receive real-time feedback and tips for improvement.',
  },
];
